...
## Donderdag 30-4-2026
In de standup gezegd dat ik gister een "oh wacht zit dat zo"-momentje had met JavaScript en dat ik daar vandaag mee verder ga en dat ik de [Webcomponents course](https://frontendmasters.com/courses/web-components/) van frontend masters op ga pakken. Ik ben met de course begonnen en heb in een code pen een websomponent gebruikt voor een [image compare webcomponent](https://codepen.io/anouk24/pen/dPOyxja). En wilde ik de [draggeble tasklist](https://codepen.io/anouk24/pen/yyVLmWz?editors=1000) gebruiken in een codepen. Ik heb de code uit de readme van hun githib gebruikt en die werkte, maar die was nog niet draggeble. Op hun website staat wel de draggeble variant dus die heb ik ook gekopieerd en geplakt en die werkt ook, ik wil er alleen nog achter komen hoe/waarom het werkt en waar ik makkelijker de voorbeeld code daarvan had kunnen vinden.

## Vrijdag 1-5-2026
In de standup (die mini was, alleen Savi en Ali waren er) heb ik aangegevend dat ik met web components aan het spelen ben en dat ik daar vandaag mee verder ga. 
Ik heb de cursus waar ik gister mee was begonnen afgemaakt. Ik heb een eigen [webcomponent gemaakt in code pen](https://codepen.io/anouk24/pen/gbLbxEO) aan de hand van die uitleg. Daarna heb ik in een [geforkte pen daarvan](https://codepen.io/anouk24/pen/wBoBrEq?editors=1010) uitleg comments neergezet. Tussendoor hebben we een meeting gehad met het kernteam van Utrecht. Die ook erg klein was, de 3 utrecht mensen en Ali en ik. We hebben de agnda puntjes besproken en we hebben het gehad over hoe AI wordt gebruikt bij Frameless, Utrecht en bij mijn generatie op school. 