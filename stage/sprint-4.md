...
- De css bestanden die in de losse variabelen staan voeg je samen tot een variabele waar je eerst de light mode aan toevoegd, dan de `@media` waarin je de darkmode toevoegd 
```
